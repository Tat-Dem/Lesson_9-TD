...
test('Successfully deleting an existing order with a correct id and valid API key', async  ({ request }) => {
...
test('Unsuccessfully deleting an order with a valid API key and invalid id', async ({ request }) => {
  const requestHeaders = {
    api_key: '1234567890123456',
  };
